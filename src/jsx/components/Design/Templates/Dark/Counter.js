...
const Counter = (props) => {
  const { products, item, cart, setCart } = props;
  ...
  return (
    <div className="row">
      <div
        ...
        className={`col-12 ${show === false ? " " : "d-none"}`}
      ...
      <div className={`col-12 ${show === true ? " " : "d-none"}`}>
        <div className="col-4">
        ...
        <div className="col-4 ">
          <Typography
            onClick={(e) => handelIncrement(e, item.qty, item.id, item.price)}
            style={{ cursor: "pointer" }}
            variant="h6"
            gutterBottom
          >
